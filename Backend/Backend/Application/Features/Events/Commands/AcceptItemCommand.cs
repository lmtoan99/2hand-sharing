...
{
    public class AcceptItemCommand : IRequest<Response<string>>
    {
        public int UserId { get; set; }
        public int EventId { get; set; }
        public int ItemId { get; set; }
    }
    public class AcceptItemCommandHandler : IRequestHandler<AcceptItemCommand, Response<string>>
    {
        ...
        public AcceptItemCommandHandler(IEventRepositoryAsync eventRepository, IGroupAdminDetailRepositoryAsync groupAdminDetail, IItemRepositoryAsync itemRepository, IMapper mapper)
        {
        ...
        public async Task<Response<string>> Handle(AcceptItemCommand request, CancellationToken cancellationToken)
        {
